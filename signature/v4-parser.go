...
//
//   querystring = X-***-Algorithm=algorithm
//   querystring += &X-***-Credential= urlencode(accessKey + '/' + credential_scope)
//   querystring += &X-***-Date=date
//   querystring += &X-***-Expires=timeout interval
